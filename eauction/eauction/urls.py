...
urlpatterns = patterns('',
    ...
    url(r'^edit_profile/$', 'django.contrib.auth.views.password_change',{'post_change_redirect': '/done/','template_name':'edit_profile.html'} ,name='edit'),
    url(r'^done/$', 'django.contrib.auth.views.password_change_done',{'template_name':'password_changed.html'}  ,name='done'),
    #url(r'^edit_profile/(?P<e_id>\d+)/$', 'Yaas.views.edit_profile', name='home'),
